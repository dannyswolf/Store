...
class Ui_edit_melanotainies_window(QtWidgets.QMainWindow):  # Πρέπει να κληρονομήσει απο QMainWindow for pyqtSignal to work
    ...
    def setupUi(self, edit_melanotainies_window):
        ...
        edit_melanotainies_window.resize(1200, 800)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)

        # Splitter
        self.splitter = QtWidgets.QSplitter(edit_melanotainies_window)
        ...
        self.left_frame_gridLayout.addWidget(self.total_label, 11, 0, 1, 2)
        ...
        self.left_frame_gridLayout.addWidget(self.total_lineEdit, 12, 0, 1, 2)
        # Παρατηρήσης
